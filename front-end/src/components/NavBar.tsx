...
import { modalState, lightMode } from "../utils/storage";
...
function NavBar() {
    ...
    const [onLightMode, setLightMode] = useRecoilState(lightMode);
    ...
    return (
        <Nav>
            <Col>
                <Logo style={{color: onLightMode ? "black" : "white"}}>Urkunde</Logo>
            </Col>
            <Col>
                <ChangeMode>
                    {!onLightMode &&
