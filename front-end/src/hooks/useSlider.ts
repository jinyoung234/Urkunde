...
import { answerButtonState, currentIndex, isAnswer, isCorrect, questionSet, sliderMotionChange } from "src/utils/storage";
...
export default function useSlider() {
    ...
    const handleRightSlider = () => {
        ...
        setCurrentIndex((prev) => prev === questions.length-1 ? prev : prev + 1);
        setAnswerState(false);
        setButtonState(false);
    }
